        ...
        <div id="cadastro">
            <form method="POST" action="{{ route('cadastro.professor', ['locale' => app()->getLocale()]) }}">
                ...
                <p id="camp">
                    ...
                    <input class="inputBorder" id="email" name="email" value="{{ old('email') }}" type="text" placeholder="nome@ifsp.edu.br" />
                ...
                <p id="camp">
                    ...
                    <input class="inputBorder" id="email" name="disciplinas" value="{{ old('disciplinas') }}" type="text" />
