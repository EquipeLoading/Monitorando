<?php
   return [
      ...
      'Manter-meLogado' => 'Manter-me Logado', 

      'Paragrafo1' => 'O sistema tem como objetivo ajudar e informar os alunos e monitores a terem um maior controle e capacidade
      de
      ...
      'Paragrafo2' => "Não fique mais se preocupando em anotar horário de atendimento do seu professor ou de seu monitor favorito,
      pois de onde você estiver o Monitorando disponibilizará todas as monitorias e plantões de dúvidas de todo o
      Instituto Federal de São Paulo, de forma organizada, prática e eficiente. ",
